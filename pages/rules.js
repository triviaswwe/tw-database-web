  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Reglamento oficial del Campeonato de Trivias de WWE. Reglas, horarios, puntuación, sanciones y más." />
      </Head>
      ...
      <div className="p-4 max-w-3xl mx-auto">
        ...
        <section id="puntuacion" className="mb-6">
          <h2 className="text-2xl font-semibold mb-2">Puntuación y Clasificación</h2>
          <ul className="list-disc list-inside text-base">
        ...
        <section id="eleccion" className="mb-6">
          <h2 className="text-2xl font-semibold mb-2">Elección de los luchadores</h2>
          <p className="text-base whitespace-pre-line">
          ...
          <ul className="list-disc list-inside text-base">
            <li>Pedirlo con tiempo durante algún Road y esperar a que dicha competición termine.</li>
            <li>Que el luchador/PJ a cambiar no se encuentre ni en el roster actual ni en la sección alumni.</li>
            <li>Haber cumplido al menos 1 año de manera ininterrumpida en el main roster representando al actual luchador/PJ.</li>
          </ul>
        </section>
        ...
        <section id="reglas" className="mb-6">
          ...
          <ul className="list-disc list-inside text-base space-y-1">
            <li>Las respuestas deben ser escritas de manera completa y sin faltas de ortografía para que se consideren válidas.</li>
            <li>Los participantes deben mantenerse activos en los grupos y participar en las trivias de manera puntual.</li>
            <li>Se requiere respeto mutuo entre todos los participantes.</li>
            <li>Está estrictamente prohibido hacer trampa, como salirse del chat para utilizar buscadores en línea o compartir respuestas con otros luchadores.</li>
            <li>Se utilizará como método las llamadas de atención a aquellos que hagan uso de estas trampas. A la segunda llamada de atención se procederá a restarle un punto al luchador. Llegadas las tres llamadas de atención el luchador queda automáticamente descalificado del combate.</li>
            <li>Es obligatorio usar "The" en wrestlers, tag teams o stables cuyo nombre esté compuesto de una sola palabra (ej: The Miz, The Undertaker, The Usos, The Vision).</li>
            <li>Es opcional usar "The" en wrestlers, tag teams o stables cuyo nombre esté compuesto por más de una palabra (ej: Big Show, New Day, Road Dogg).</li>
        ...
        <section id="disputas" className="mb-6">
          <h2 className="text-2xl font-semibold mb-2">Mecanismos de Resolución de Disputas</h2>
          <p className="text-base">
        ...
        <section id="sanciones" className="mb-6">
          <h2 className="text-2xl font-semibold mb-2">Responsabilidades y Sanciones</h2>
          <p className="text-base">
          ...
          <p className="text-base">
            ...
            mismas sanciones o no, a otros competidores. Este es el baremo a seguir:
          </p>
          ...
          <ol className="list-decimal list-inside text-base mb-4">
            ...
            <li>En combate de Road, alterar el combate y obtener una oportunidad titular/salvarse del descenso.</li>
          ...
          <ul className="list-disc list-inside text-base mb-4">
            <li>Un Road de suspensión sin competir en ninguna marca (al regreso en NXT).</li>
            <li>Dos Roads sin poder competir por un campeonato (desde el regreso).</li>
            <li>No poder competir en PLE Bookeado (los tres Roads de sanción).</li>
          </ul>
          ...
          <p className="text-base">
            ...
            por cualquier campeonato individual de cualquiera de las tres marcas principales.
          </p>
          <ol className="list-decimal list-inside text-base mb-4">
            <li>Dicha sanción no aplica para los campeonatos en parejas.</li>
            <li>Al ser el sancionado poseedor de un campeonato individual, dicha sanción correrá a partir de que el competidor pierda el campeonato.</li>
          </ol>
          <p className="text-base">
            Dependiendo de la gravedad y la reiteración de los actos o
            comentarios, se podrán aplicar estas mismas sanciones o no, a otros competidores.
          </p>
          <h3 className="text-xl font-semibold">PRIMERA ACCIÓN INDEBIDA:</h3>
          <ul className="list-disc list-inside text-base mb-2">
            <li>Suspensión sin competir por un título individual de mínimo un road.</li>
          </ul>
          <h3 className="text-xl font-semibold">SEGUNDA ACCIÓN INDEBIDA:</h3>
          <ul className="list-disc list-inside text-base mb-2">
            <li>Suspensión sin competir por un título individual de mínimo dos roads.</li>
          </ul>
          <h3 className="text-xl font-semibold">TERCERA ACCIÓN INDEBIDA:</h3>
          <ul className="list-disc list-inside text-base mb-2">
            <li>Suspensión sin competir por un título individual de mínimo tres roads.</li>
          </ul>
