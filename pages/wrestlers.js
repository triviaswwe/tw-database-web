  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Listado completo de wrestlers del Campeonato de Trivias WWE. Filtrá por status y nombre." />
      </Head>
      ...
      <div className="p-6 max-w-5xl mx-auto">
        ...
        <input type="text" placeholder="Filter by wrestler name" value={nameFilter}
        ...
        {loading ? <Spinner /> : (
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
            {wrestlers.length === 0 ? <p>No wrestlers found.</p> : wrestlers.map((w) => (
                ...
                <div className="flex items-center p-4 dark:bg-zinc-950 border rounded shadow hover:shadow-lg transform transition-transform duration-200 ease-in-out hover:scale-105 cursor-pointer">
                  {w.image_url && (
                    <div className="w-16 h-16 overflow-hidden relative flex-shrink-0">
                      <img src={w.image_url} alt={w.wrestler} className="w-full h-full object-cover" style={{ objectPosition: 'top' }} />
